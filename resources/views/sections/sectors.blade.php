<form action="/dashboard/sectors" method="GET" class="d-flex justify-content-between mB-32">
    ...
    <button type="submit" class="btn btn-outline-secondary mL-16" name="btnCreateSectors">Criar</button>
</form>
