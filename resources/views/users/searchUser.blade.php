        ...
        <tbody>
                ...
                @foreach ($users as $user)
                    <tr class="border-bottom">
                        ...
                        <td>
                            <button type="button" class="btn btn-outline-secondary" id="deleteUser" data-bs-toggle="modal" data-bs-target="#modalUser">
            ...
            @else
                <p>Nenhum registro foi encontrado, <a href="/dashboard/users" class="text-primary">ver todos</a></p>
            @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <span>Você tem certeza que deseja excluir este usuário?</span>
            </div>
